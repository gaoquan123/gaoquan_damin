        ...
        <div class="Newform m-t-50">
            <el-form ref="ruleForm" :rules="rules" :model="ruleForm" label-width="150px">
                ...
                <el-form-item label="还款方式" prop="payWay">
                    <el-select disabled="" placeholder="请选择还款方式" v-model="ruleForm.payWay" @change="payWayChange">
                ...
                <el-form-item label="资产期限" prop="timeLimitType">
					<el-radio-group v-model="ruleForm.timeLimitType" @change="timeLimitTypeChange">
						<el-radio :disabled="ruleStatus.timeLimitTypeDisabled" label="DATE"  border size="medium">固定日期</el-radio>
						<el-radio :disabled="ruleStatus.timeLimitTypeDisabled" label="DAYS" border size="medium">固定期限</el-radio>
                        <!-- 如果是供应链 -->
						<el-radio :disabled="ruleStatus.timeLimitTypeDisabled" v-if="ruleStatus.timeLimitType" label="FPN" border size="medium">固定期数</el-radio>
					</el-radio-group>
				</el-form-item>
                ...
                <el-form-item label="资产模式" prop="model">
                 ...
                 <el-form-item label="所属渠道" prop="channelId">
                    <el-select placeholder="请选择所属渠道" v-model="ruleForm.channelId" @change="channelIdChange(item.title)">
